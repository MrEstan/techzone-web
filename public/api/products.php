...
switch ($action) {
    case 'list':
        $stmt = $pdo->query("SELECT * FROM products ORDER BY CASE category WHEN 'airpods' THEN 1 WHEN 'auriculares' THEN 2 WHEN 'parlantes' THEN 3 WHEN 'fundas' THEN 4 WHEN 'cargadores' THEN 5 ELSE 6 END, CASE brand WHEN 'Apple' THEN 1 WHEN 'JBL' THEN 2 ELSE 3 END, name");
