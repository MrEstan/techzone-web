...
-- 1. Tabla productos (con URL de imagen en Storage) - CHECK removido para permitir categorías dinámicas
...
-- Si la tabla ya existía con CHECK, lo eliminamos
DO $$ BEGIN
...
INSERT INTO public.categories (slug, name) VALUES
  ('airpods','AirPods'),('auriculares','Auriculares'),('parlantes','Parlantes'),
  ('fundas','Fundas'),('cargadores','Cargadores'),('accesorios','Accesorios')
...
CREATE POLICY "Allow all for anon categories" ON public.categories FOR ALL USING (true) WITH CHECK (true);
